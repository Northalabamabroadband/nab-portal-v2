...
def network_polling_error(network: dict) -> str | None:
    cache = network.get("cache")
...
async def mission_control_overview(
    ...
    try:
        ...
        network_error = network_polling_error(network)
...
def capability_parity(
    ...
    capabilities = [
        ...
        {"domain": "Desktop command synchronization", "read": True, "write": True, "source": "Shared work orders + persistent desktop outages"},
...
def admin_capabilities(
    ...
    return {
        ...
        "features": {
            ...
            "portal_saved_session_validation": True,
            "network_polling_response_validation": True,
